<nav class="navbar navbar-inverse">
    ...
    <ul class="nav">
        <li class="active"><a href="?controller=producto&action=search_prodBarra">Realizar registro</a></li>
        <li class="active"><a href="?controller=producto&action=search_prod_existenciasB">Ver existencias</a></li>
