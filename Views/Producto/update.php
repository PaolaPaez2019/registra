...
<form action='producto_controller.php' method='post' id="update_form">
	...
	<table id="update_table">
		...
		<tr>
			<td><label>Stock Máximo:</label></td><td><input type='text' name='stockmax' maxlength='20' value='<?php echo $producto->stockmax; ?>'></td>
		</tr>
		<tr>
			<td><label>Stock Mínimo:</label></td><td><input type='text' name='stockmin' maxlength='20' value='<?php echo $producto->stockmin; ?>'></td>
		</tr>
		<tr>
